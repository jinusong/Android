...
public class Fragment_meal8 extends android.support.v4.app.Fragment{

    String date;

    public Fragment_meal8() {
    }

    @SuppressLint("ValidFragment")
    public Fragment_meal8(String date) {
        this.date = date;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        getValue();
        View view = (View) inflater.inflate(R.layout.fragment_meal8, container, false);
