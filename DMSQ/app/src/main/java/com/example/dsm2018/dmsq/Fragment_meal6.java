...
public class Fragment_meal6 extends android.support.v4.app.Fragment{

    String date;

    public Fragment_meal6() {
    }

    @SuppressLint("ValidFragment")
    public Fragment_meal6(String date) {
        this.date = date;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        getValue();
        View view = (View) inflater.inflate(R.layout.fragment_meal6, container, false);
