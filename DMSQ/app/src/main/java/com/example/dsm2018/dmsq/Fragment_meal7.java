...
public class Fragment_meal7 extends android.support.v4.app.Fragment{

    String date;

    public Fragment_meal7() {
    }

    @SuppressLint("ValidFragment")
    public Fragment_meal7(String date) {
        this.date = date;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        getValue();
        View view = (View) inflater.inflate(R.layout.fragment_meal7, container, false);
